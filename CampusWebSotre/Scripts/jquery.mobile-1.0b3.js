...
$.widget( "mobile.listview", $.mobile.widget, {
	...
	_itemApply: function( $list, item ) {
		...
		$countli.addClass( "ui-btn-up-" + ( $list.jqmData( "counttheme" ) || this.options.countTheme ) + " ui-btn-corner-all1" );
	...
	_removeCorners: function( li, which ) {
		...
		li = li.add( li.find( ".ui-btn-inner1, .ui-li-link-alt, .ui-li-thumb" ) );
	...
	_refreshCorners: function( create ) {
		...
		if ( this.options.inset ) {
			...
			$topli.add( $topli.find( ".ui-btn-inner1" ) )
				.find( ".ui-li-link-alt" )
			...
			$bottomli.add( $bottomli.find( ".ui-btn-inner1" ) )
				.find( ".ui-li-link-alt" )
	...
	refresh: function( create ) {
		...
		for ( var pos = 0, numli = li.length; pos < numli; pos++ ) {
			...
			item.add( item.children( ".ui-btn-inner1" ) ).addClass( itemClass );
...
$.widget( "mobile.button", $.mobile.widget, {
	options: {
		...
		shadow: true,
		iconshadow: true,
		initSelector: "button, [type='submit'], [type='reset'], [type='image']"
	},
	_create: function() {
		var $el = this.element,
			o = this.options,
	...
	_create: function() {
		...
		var self = this,
			...
			slider = $( "<div class='ui-slider " + selectClass + " ui-btn-down-" + trackTheme +
									" ui-btn-corner-all1' role='application'></div>" ),
...
$.widget( "mobile.textinput", $.mobile.widget, {
	...
	_create: function() {
		...
		if ( input.is( "[type='search'],:jqmData(type='search')" ) ) {
			...
			focusedEl = input.wrap( "<div class='ui-input-search ui-shadow-inset ui-btn-corner-all1 ui-btn-shadow ui-icon-searchfield" + themeclass + "'></div>" ).parent();
...
(function( $, undefined ) {
	var extendSelect = function( widget ){
		...
		var select = widget.select,
			...
			screen = $( "<div>", {"class": "ui-select1menu-screen ui-screen-hidden"} ).appendTo( thisPage ),
			...
			listbox =  $("<div>", { "class": "ui-select1menu ui-select1menu-hidden ui-overlay-shadow ui-corner-all ui-body-" + widget.options.overlayTheme + " " + $.mobile.defaultDialogTransition } ).insertAfter(screen),

			list = $( "<ul>", {
				"class": "ui-select1menu-list",
				"id": menuId,
				"role": "listbox",
		...
		$.extend( widget, {
			...
			close: function() {
				...
				if ( self.menuType == "page" ) {
					...
					self.listbox.addClass( "ui-select1menu-hidden" ).removeAttr( "style" ).removeClass( "in" );
					self.list.appendTo( self.listbox );
					self._focusButton();
				}
			...
			open: function() {
				...
				if ( menuHeight > screenHeight - 80 || !$.support.scrollTop ) {
					...
					self.listbox.append( self.list )
						.removeClass( "ui-select1menu-hidden" )
						.css({
							top: newtop,
							left: newleft
						})
				...
				self.select.find( "option" ).each( function( i ) {
					...
					if ( !this.getAttribute( "value" ) || text.length == 0 || $this.jqmData( "placeholder" ) ) {
						if ( o.hidePlaceholderMenuItems ) {
							classes.push( "ui-select1menu-placeholder" );
						}
...
//		this.select = this.element.wrap( "<div class='ui-select1'>" );
//		this.selectID  = this.select.attr( "id" );
//		this.label = $( "label[for='"+ this.selectID +"']" ).addClass( "ui-select1" );
...
//			this.select.addClass( "ui-select1-nativeonly" );
//		}

//		// Add counter for multi selects
//		if ( this.isMultiple ) {
//			this.buttonCount = $( "<span>" )
//				.addClass( "ui-li-count ui-btn-up-c ui-btn-corner-all1" )
//				.hide()
//				.appendTo( button );
//		}
...
$.fn.buttonMarkup = function( options ) {
	return this.each( function() {
		...
		if ( o.corners ) {
			buttonClass += " ui-btn-corner-all1";
			innerClass += " ui-btn-corner-all1";
		}
...
$.fn.controlgroup = function( options ) {
	...
	return this.each(function() {
		...
		function flipClasses( els ) {
			els.removeClass( "ui-btn-corner-all1 ui-shadow" )
		...
		flipClasses( $el.find( ".ui-btn-inner1" ) );
