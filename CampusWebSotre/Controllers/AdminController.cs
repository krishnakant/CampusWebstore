...
namespace CampusWebSotre.Controllers
{
    public class AdminController : WebController
    {
        ...
        public ActionResult JsonCloseOrders()
        {
            ...
            var flag = OrderService.CloseOrder(StoreNumber, ordertoclose, UvUsername,
        ...
        public JsonResult JsonUpdateCustomerDetail(CustomerDetailViewModel model)
        {
            if (model != null)
            {
                ...
                var objUserModel = AccountSettingsService.UpdateUser(StoreNumber, model.CustomerDetail.UserName ?? "",
                                                                     model.CustomerDetail.FirstName ?? "", model.CustomerDetail.LastName ?? "", model.CustomerDetail.Address ?? "",
                                                                     model.CustomerDetail.Address2 ?? "",
                                                                     model.CustomerDetail.City ?? "", model.CustomerDetail.State ?? "", model.CustomerDetail.Zip ?? "", model.CustomerDetail.Country ?? "",
                                                                     model.CustomerDetail.Email, model.CustomerDetail.DayPhone, model.CustomerDetail.Evening,
                                                                     model.CustomerDetail.ShipToName ?? "",
                                                                     model.CustomerDetail.ShipAddress ?? "", model.CustomerDetail.ShipAddress2 ?? "",
                                                                     model.CustomerDetail.ShipCity ?? "",
                                                                     model.CustomerDetail.ShipState ?? "", model.CustomerDetail.ShipZip ?? "", model.CustomerDetail.ShipCountry ?? "",
                                                                     model.CustomerDetail.ShipInstruc ?? "", emailoptin, model.CustomerDetail.DropDownAccountType, UvUsername,
        ...
        /// <summary>
        /// Save files to selected folders...
        /// </summary>
        /// <param name="folder"></param>
        /// <param name="filename"></param>
        /// <returns></returns>
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AttachFiles(string folder, string filename)
        {
            var filepath = Server.MapPath(folder.Replace("/Admin", "")) + "/" + filename;
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult FileUploadDone()
        {
            return View();
        }
