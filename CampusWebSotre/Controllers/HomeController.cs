            ...
            try
            {
                if (Session["BOOKS"] != null)
                {
                    ...
                    if (courseSectionModel != null)
                    {
                        ...
                        // oos=Out of Stock
                        if (!priceType.Equals("oos") && (priceType.Equals("new") || priceType.Equals("used")))
                        {
                            if (item != null)
                            {
                                var newPrice = 0.00;
                                ...
                                var shoppingCartModel = new ShoppingCartModel
                                                            {
                                                                Id = isbn,
                                                                Isbn = isbn,
                                                                ActualPrice = priceType.Equals("new") ? newPrice : usedPrice,
                                                                NewUsed = priceType,
                                                                Type = priceType,
                                                                Title = item.Title,
                                                                NewPrice = newPrice,
                                ...
                                else
                                {
                                    ...
                                    if (shoppingModel != null)
                                    {
                                        ...
                                        shoppingModel.ActualPrice = priceType.Equals("new") ? newPrice : usedPrice;
                                        shoppingModel.Type = (priceType);
                                        Session["CARTITEMS"] = lstShoppingCartModels;
